 ...
 * @returns {void}
 */function wrapTargetWithHandler(target,handler){wrappedListeners[target]=function(e){e.stopPropagation();handler(target,function(){target.removeEventListener('click',wrappedListeners[target]);target.click(e);});};target.addEventListener('click',wrappedListeners[target]);}/**
